...
#function that will take the commands  to convert voice into text
    ...
    def run_jarvis(self):
        ...
        while True:
            ...
            #Eg: jarvis sleep the system
            ...
            elif 'None' or 'none' in self.command:
                pass
            else:
                import asyncio
                ...
                async def main():
                    client = PyAsyncCAI('aa86ee006fb4d052e1d2a6a9f02fbdb454c8e4a5')
    ...
    def Intro(self):
        while True:                
            ...
            if ("wake up" in self.permission) or ("get up" in self.permission) or ("start"):
                self.run_jarvis()
