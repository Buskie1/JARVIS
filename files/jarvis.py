...
from jarvisUi import Ui_MainWindow as Ui_jarvisUi
...
#function that will take the commands  to convert voice into text
    ...
    def run_jarvis(self):
        ...
        while True:
            ...
            #Eg: jarvis sleep the system
            ...
            elif ('None' in self.command) or ("none" in self.command):
                pass
                ...
                try:
                    ...
                    print(f"an error fix it you dumbo {e}")
                    import traceback
                    traceback.print_exc()
    ...
    def Intro(self):
        while True:                
            ...
            if ("wake up" in self.permission) or ("get up" in self.permission) or ("start" in self.permission):
                self.run_jarvis()
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("../UI/main.gif")
